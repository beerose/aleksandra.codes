...
### What will be the format of this blog post?
...
### Setting up Supabase in the Astro project
...
Inside, I'm using the `react-rewards` library. It will render some confetti whenever a user draws a name! Run the following command to install it:
