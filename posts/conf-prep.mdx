...
A post that no one asked for, but here it goes anyway.
...
research, content, narration, slides, dry runs. I do this to ensure I always
find the time, which can be difficult, considering I prepare most of the talks
in my free time and try to have a social life outside of work. In reality, I
work approx 8 hours/week per talk.
...
narration flow in FigJam, but I write the script in Word.
