...
VERY tempting to go over it, but I quickly figured it wouldn't entertain anyone
besides me 🫠 Another thing is that with Effect.ts, _you don't need that_.
...
Effect is designed to handle all of that. Easily. In a type-safe way.
